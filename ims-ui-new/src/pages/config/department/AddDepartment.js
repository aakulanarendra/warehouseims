...
const addUrl = Constants.DEPARTMENT_ADD;
        ...
        <div>
            ...
            >
                ...
                <DialogContent>
                    ...
                    >
                        <div>
                            {renderInputTextField('Department Code', 'departmentCode', true, ['required'])}
                            {renderInputTextField('Department Name', 'departmentName', true, ['required', 'matchRegexp:\[A-Za-z0-9\]'])}
                        </div>
                    </ValidatorForm>
                </DialogContent>
                <DialogActions>
