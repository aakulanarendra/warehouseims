...
function layoutReducer(state, action) {
  switch (action.type) {
    ...
    case "TOGGLE_SEARCHBAR":
      return { ...state, isProductSearchBar: true };
    default: {
...
export { LayoutProvider, useLayoutState, useLayoutDispatch, toggleSidebar,toggleSearchBar };
...
function toggleSearchBar(dispatch) {
  dispatch({
